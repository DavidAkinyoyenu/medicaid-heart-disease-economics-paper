...
conn.execute("""
    ...
    SELECT * FROM read_parquet('intermediate/cdc_wonder_adults_45_64.parquet')
""")
...
conn.execute("""
    ...
    WHERE c.state IS NOT NULL
      ...
      AND e.expansion_year IN (2014, 3000)
    ORDER BY c.state, c.year
""")

OUT = 'panel_adults_45_64_2014_and_never_unemployment_poverty_cigarette'
