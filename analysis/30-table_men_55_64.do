* DiD build-up table: Heart Disease Mortality, Males 55-64
...
esttab m1 m2 m3 m4, ///
    ...
    title("DiD: Heart Disease Mortality, Males 55-64")

* --- LaTeX export ---
esttab m1 m2 m3 m4 using "/Users/davidakinyoyenu/Downloads/00 26 Spring/14.33 - Adv Econometrics/Data/Master_Build_Analysis/output/table_20_men_55_64.tex", replace ///
    se star(* 0.10 ** 0.05 *** 0.01) ///
    label booktabs ///
    mtitles("No FE" "State+Year FE" "+Econ Controls" "+Cigarette Tax") ///
    keep(treat_post unemployment_rate poverty_rate cigarette_tax_per_pack) ///
...
esttab m1 m2 m3 m4 using "/Users/davidakinyoyenu/Downloads/00 26 Spring/14.33 - Adv Econometrics/Data/Master_Build_Analysis/output/table_20_men_55_64.rtf", replace ///
    se star(* 0.10 ** 0.05 *** 0.01) ///
    label ///
    mtitles("No FE" "State+Year FE" "+Econ Controls" "+Cigarette Tax") ///
    keep(treat_post unemployment_rate poverty_rate cigarette_tax_per_pack) ///
