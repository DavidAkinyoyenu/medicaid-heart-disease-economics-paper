* DiD build-up table: All-Cause Mortality, Adults 25-64 (Men + Women)
* Requires: reghdfe, estout (ssc install reghdfe estout)

use "/Users/davidakinyoyenu/Downloads/00 26 Spring/14.33 - Adv Econometrics/Data/Master_Build_Analysis/build/output/panel_adults_25_64_all_cause_unemployment_poverty_cigarette.dta", clear
...
esttab m1 m2 m3 m4, ///
    ...
    title("DiD: All-Cause Mortality, Adults 25-64")

* --- LaTeX export ---
esttab m1 m2 m3 m4 using "/Users/davidakinyoyenu/Downloads/00 26 Spring/14.33 - Adv Econometrics/Data/Master_Build_Analysis/output/table_26_adults_25_64_all_cause.tex", replace ///
    se star(* 0.10 ** 0.05 *** 0.01) ///
    label booktabs ///
    mtitles("No FE" "State+Year FE" "+Econ Controls" "+Cigarette Tax") ///
    keep(treat_post unemployment_rate poverty_rate cigarette_tax_per_pack) ///
...
esttab m1 m2 m3 m4 using "/Users/davidakinyoyenu/Downloads/00 26 Spring/14.33 - Adv Econometrics/Data/Master_Build_Analysis/output/table_26_adults_25_64_all_cause.rtf", replace ///
    se star(* 0.10 ** 0.05 *** 0.01) ///
    label ///
    mtitles("No FE" "State+Year FE" "+Econ Controls" "+Cigarette Tax") ///
    keep(treat_post unemployment_rate poverty_rate cigarette_tax_per_pack) ///
