...
## 1. Project Overview
This repository documents an econometric analysis investigating the relationship between Medicaid Expansion and the mortatility rate from heart disease among US states. The study pulls data from five primary sources to create a state-year panel from 1999 to 2019 for difference-in-difference testing. The full paper can be found as The Effect of Medicaid Expansion on Ischaemic Heart Disease Mortality.pdf. 
