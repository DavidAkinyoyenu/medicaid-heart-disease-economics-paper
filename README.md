...
- Example: file 23-reg_adults_45_65
    ...
    - Second digit: 3 implies this is third file in the section
...
The analysis folder is the second folder of our analysis and details how to use the completed panel data to run difference-in-difference regressions. 
- Tools: Stata
...
- Data Sections:
    - Section 1: Do files to create exploratory event studies and summary statistics, starting with 10-event-study.do
...
This final section contains the output of all regression analyses in the form of pictures for event studies and text files for summary statistics and regression tables. 
